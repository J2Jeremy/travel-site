...
var showModal = new _Modal2.default();
...
var MobileMenu = function () {
  ...
  */
		...
		this.siteHeader = (0, _jquery2.default)(".site-header"); //so we can add bg color and transition to mobile nav
		...
		value: function createHeaderWaypoint() {
			...
			new Waypoint({
				...
				handler: function handler(direction) {
					//add param so darker header returns to original transparent using 'direction'.
				...
				new Waypoint({
					...
					handler: function handler(direction) {
						if (direction == "down") {
							...
							that.headerLinks.removeClass("is-current-link");
							(0, _jquery2.default)(matchingHeaderLink).addClass("is-current-link"); //update class in primary nav (where header links are styled)
						}
					},
